      ...
      <div className='w-full flex flex-wrap gap-4 pt-5 gap-y-6'>
        {
          employees.map((item,index)=>(
            <div className='border border-green-200 rounded-xl max-w-56 overflow-hidden cursor-pointer' key={index}>
              <img className='bg-orange-50 hover:bg-gradient-to-r from-primary to-orange-500 transition-all duration-500' src={item.image} alt="Staff member's profile image" />
              <div className='p-4'>
